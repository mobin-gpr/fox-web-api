...
urlpatterns = [
    path('register/', RegisterAPIView.as_view(), name='register'),  # Register a new user endpoint
    path('confirm_email/<str:token>/', EmailVerificationAPIView.as_view(), name='confirm_email'),  # Confirm email by token endpoint
    path('resend_confirm_email/', ResendEmailVerificationAPIView.as_view(), name='resend_confirm_email'),  # Resend confirm email endpoint
